...
Search.getInitialProps = async ({ query }) => {
	try {
		...
		const thisQuery = `/jobs?_where[_or][0][title_contains]=${fil}&_where[_or][1][company_contains]=${fil}&_where[_or][2][tags.slug]=${fil}&_where[_or][3][slug_contains]=${fil}&_sort=pinned:DESC,created_at:desc&_limit=40`;
