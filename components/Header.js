...
class Header extends React.Component {
	...
	handleScroll(event) {
		...
		if (scrollY > 0) menuDesktop.classList.add("active");
		else menuDesktop.classList.remove("active");
	}
			...
			<div>
				<nav className="desktop">
					<div className="container">
						<Link href="/">
							<div className="logo">
								<img src="/static/images/logo-big.jpg" />
							</div>
						</Link>
					...
					<div className="links">
						...
						<li>
							...
							<ul className="submenu submenu-categories">
								<li>
									<a href={`${WEB_URL}/categoria/programacion`}>Programación</a>
								</li>
								<li>
									<a href={`${WEB_URL}/categoria/diseno`}>Diseño</a>
								</li>
								<li>
									<a href={`${WEB_URL}/categoria/marketing`}>Marketing</a>
								</li>
								<li>
									<a href={`${WEB_URL}/categoria/atencion-al-cliente`}>Atención al cliente</a>
								</li>
								<li>
									<a href={`${WEB_URL}/categoria/gamedev`}>GameDev</a>
								</li>
								<li>
									<a href={`${WEB_URL}/categoria/otros`}>Otros</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul className="submenu submenu-social-media">
								<li>
									<a href={`https://t.me/trabajos_remotos`}>Telegram</a>
								</li>
								<li>
              ...
              <Link href="https://tally.so/r/nGoQjn">
				...
				<div className="mobile">
					<div className="nav">
						{/* Logo */}
						<Link href="/">
							<div onClick={this.closeMenu} className="logo">
								<img src="/static/images/logo-big.jpg" />
							</div>
						</Link>
