...
const PublishBannerHero = () => {
  return (
    <div style={{ padding: "0 1rem", overflow: "hidden" }} className="container">
      <div
        className="flex flex-col lg:flex-row items-center justify-between overflow-hidden w-full mx-auto z-20"
...
export default PublishBannerHero;
